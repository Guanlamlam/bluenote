...
//     // Map<String, dynamic> authorFCM = await FirebaseService.instance.getUserData(authorUid);
//     // String authorFcmToken = authorFCM['fcmToken'];
//     //
//     //
//     // // Send notification to the post author except the author like their own posts
//     // if (authorFcmToken.isNotEmpty && username != null && userId != widget.authorUid) {
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                if (selectedPost.imageUrls[0].isNotEmpty)
                  Column(
                    children: [
                      SizedBox(
                        width: double.infinity,
                        ...
                        child: Stack(
                          children: [
                            PageView.builder(
                              itemCount: selectedPost.imageUrls.length,
                              onPageChanged: _onPageChanged,
                              itemBuilder: (context, index) {
                                return GestureDetector(
                                  onTap: () {
                                  ...
                                  child: InteractiveViewer(
                                    ...
                                    maxScale: 3.0,
                                    child: CachedNetworkImage(
                                      imageUrl: selectedPost.imageUrls[index],
                                      width: double.infinity,
                                      height: double.infinity,
                                      fit: BoxFit.cover,
                            ...
                            if (selectedPost.imageUrls.length > 1)
                              Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Text(
                                    '${_currentPageIndex + 1} / ${selectedPost.imageUrls.length}',
                                    style: TextStyle(
                                      color: Colors.white,
                                      fontWeight: FontWeight.bold,
                                      fontSize: 10,
